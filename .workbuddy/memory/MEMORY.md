...
### AI 生图作品集
- **目录**：`ai-generated-images/`
- **记录文件**：`README.md`（人读）+ `catalog.json`（机读，供网站用）
- **当前风格**：
  1. ins清新风产品摄影（已完成芦荟凝胶 #001）
- **用途**：后续统一放入个人作品集网站 jiangjiehui.top
- **图片生成注意**：混元图片队列容易超时，1024x1536不支持，可用768x1024
